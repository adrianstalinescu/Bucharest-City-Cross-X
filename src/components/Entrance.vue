        ...
        <div class="align-self-center width-100">
          <v-card-title class="pa-0 justify-align-center">
            <div class="margin-L-R">
              ...
              <v-icon color="success" right>mdi-lock-reset</v-icon>
            </div>
          </v-card-title>
      ...
      <v-card width="25vw" height="100%" elevation="0" class="margin-L-R align-self-center display-flex">
        <div class="align-self-center width-100">
          <v-card-title class="pa-0 justify-align-center">
            <div class="margin-L-R">
              <span>TRANSIT</span>
              <v-icon color="success" right>mdi-tram-side</v-icon>
            </div>
          </v-card-title>
          <v-container grid-list-sm class="pa-0 justify-align-center">
            <v-layout row wrap>
      ...
      <v-card width="70vw" height="100%" elevation="0" class="margin-L-R align-self-center display-flex">
        <div class="align-self-center width-100">
          <v-card-title class="padding-zero">
            <div class="margin-L-R">
              <span>Join</span>
              <v-icon color="success" right>mdi-plus-circle-outline</v-icon>
            </div>
          </v-card-title>
          <v-container grid-list-sm class="padding-zero">
            <v-layout wrap>
              ...
              <v-flex xs6>
                <v-text-field prepend-inner-icon="mdi-card-account-details-outline" label="Name" v-model="name" color="success" class="padding-zero"></v-text-field>
              </v-flex>
              <v-flex xs6>
                <v-text-field prepend-inner-icon="mdi-phone" label="Phone" color="success" v-model="phone" class="padding-zero"></v-text-field>
              </v-flex>
              <v-flex xs6>
                <v-select prepend-inner-icon="mdi-account-circle-outline" :items="genderSelect" v-model="gender" color="success" label="Gender"></v-select>
              </v-flex>
              <v-flex xs6>
                <v-menu
                  ref="menu"
